  ...
  <v-layout class="a-sellers-item elevation-3 justify-space-between">
    ...
    <v-flex>
      <v-btn icon v-if="!sellers_data.favorite">
        <v-icon class="item_fav add" @click="addToFavorite" color="#cecece">favorite</v-icon>
      </v-btn>
      <v-btn icon v-if="sellers_data.favorite">
        <v-icon class="item_fav added" @click="addToFavorite" color="#41b883">favorite</v-icon>
      </v-btn>
    </v-flex>
